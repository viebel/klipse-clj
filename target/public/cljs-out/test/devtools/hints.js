...
var map__34035 = top_item;
var map__34035__$1 = (((((!((map__34035 == null))))?(((((map__34035.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34035.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34035):map__34035);
var file = cljs.core.get.call(null,map__34035__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34035__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34035__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34034){var _e = e34034;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___34037 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___34037)){
var seen_errors_34038 = temp__5802__auto___34037;
if(cljs.core.truth_(seen_errors_34038.has(self))){
} else {
seen_errors_34038.add(self);

var temp__5804__auto___34039 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___34039)){
var sense_34040 = temp__5804__auto___34039;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34040)].join('');
} else {
}
}
} else {
