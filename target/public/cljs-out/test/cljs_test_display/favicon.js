...
return cljs.core.map.call(null,(function (p1__21109_SHARP_){
return html_coll.item(p1__21109_SHARP_);
...
return cljs.core.some.call(null,((function (rel,temp__5804__auto__){
return (function (p1__21110_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__21110_SHARP_);
});})(rel,temp__5804__auto__))
...
var temp__5802__auto____$1 = cljs_test_display.favicon.find_existing_link.call(null);
...
var ctx_21111 = cvs.getContext("2d");
ctx_21111.fillStyle = color;

ctx_21111.fillRect((0),(0),size,size);
