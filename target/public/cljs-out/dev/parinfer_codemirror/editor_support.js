...
var start_line = cljs.core.get.call(null,map__26887__$1,new cljs.core.Keyword(null,"start-line","start-line",-41746654));
var end_line = cljs.core.get.call(null,map__26887__$1,new cljs.core.Keyword(null,"end-line","end-line",1837326455));
var num_new_lines = cljs.core.get.call(null,map__26887__$1,new cljs.core.Keyword(null,"num-new-lines","num-new-lines",-1319642646));
var lines = (function (){var iter__4523__auto__ = ((function (map__26887,map__26887__$1,start_line,end_line,num_new_lines){
return (function parinfer_codemirror$editor_support$compute_cm_change_$_iter__26889(s__26890){
return (new cljs.core.LazySeq(null,((function (map__26887,map__26887__$1,start_line,end_line,num_new_lines){
return (function (){
var s__26890__$1 = s__26890;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__26890__$1);
if(temp__5720__auto__){
var s__26890__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__26890__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__26890__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__26892 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__26891 = (0);
while(true){
if((i__26891 < size__4522__auto__)){
var i = cljs.core._nth.call(null,c__4521__auto__,i__26891);
cljs.core.chunk_append.call(null,b__26892,cm.getLine(i));

var G__26893 = (i__26891 + (1));
i__26891 = G__26893;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26892),parinfer_codemirror$editor_support$compute_cm_change_$_iter__26889.call(null,cljs.core.chunk_rest.call(null,s__26890__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26892),null);
}
} else {
var i = cljs.core.first.call(null,s__26890__$2);
return cljs.core.cons.call(null,cm.getLine(i),parinfer_codemirror$editor_support$compute_cm_change_$_iter__26889.call(null,cljs.core.rest.call(null,s__26890__$2)));
}
} else {
return null;
}
...
});})(map__26887,map__26887__$1,start_line,end_line,num_new_lines))
,null,null));
});})(map__26887,map__26887__$1,start_line,end_line,num_new_lines))
;
...
parinfer_codemirror.editor_support.fix_text_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (cm,p__26896){
...
var change = cljs.core.get.call(null,map__26897__$1,new cljs.core.Keyword(null,"change","change",-1163046502),null);
var use_cache_QMARK_ = cljs.core.get.call(null,map__26897__$1,new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),false);
...
var new_text = (function (){var G__26899 = mode;
...
/** @this {Function} */
parinfer_codemirror.editor_support.fix_text_BANG_.cljs$lang$applyTo = (function (seq26894){
var G__26895 = cljs.core.first.call(null,seq26894);
var seq26894__$1 = cljs.core.next.call(null,seq26894);
