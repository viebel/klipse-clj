...
var m__4305__auto__ = (parinfer_codemirror.editor_support.cm_key[goog.typeOf(x__4304__auto__)]);
if((!((m__4305__auto__ == null)))){
return m__4305__auto__.call(null,this$);
} else {
var m__4302__auto__ = (parinfer_codemirror.editor_support.cm_key["_"]);
...
var x__4304__auto__ = (((this$ == null))?null:this$);
var m__4305__auto__ = (parinfer_codemirror.editor_support.get_prev_state[goog.typeOf(x__4304__auto__)]);
if((!((m__4305__auto__ == null)))){
return m__4305__auto__.call(null,this$);
} else {
var m__4302__auto__ = (parinfer_codemirror.editor_support.get_prev_state["_"]);
if((!((m__4302__auto__ == null)))){
return m__4302__auto__.call(null,this$);
} else {
...
var x__4304__auto__ = (((this$ == null))?null:this$);
var m__4305__auto__ = (parinfer_codemirror.editor_support.frame_updated_QMARK_[goog.typeOf(x__4304__auto__)]);
if((!((m__4305__auto__ == null)))){
return m__4305__auto__.call(null,this$);
} else {
var m__4302__auto__ = (parinfer_codemirror.editor_support.frame_updated_QMARK_["_"]);
if((!((m__4302__auto__ == null)))){
return m__4302__auto__.call(null,this$);
} else {
...
var x__4304__auto__ = (((this$ == null))?null:this$);
var m__4305__auto__ = (parinfer_codemirror.editor_support.set_frame_updated_BANG_[goog.typeOf(x__4304__auto__)]);
if((!((m__4305__auto__ == null)))){
return m__4305__auto__.call(null,this$,value);
} else {
var m__4302__auto__ = (parinfer_codemirror.editor_support.set_frame_updated_BANG_["_"]);
if((!((m__4302__auto__ == null)))){
return m__4302__auto__.call(null,this$,value);
} else {
...
var start_line = cljs.core.get.call(null,map__26625__$1,new cljs.core.Keyword(null,"start-line","start-line",-41746654));
var end_line = cljs.core.get.call(null,map__26625__$1,new cljs.core.Keyword(null,"end-line","end-line",1837326455));
var num_new_lines = cljs.core.get.call(null,map__26625__$1,new cljs.core.Keyword(null,"num-new-lines","num-new-lines",-1319642646));
var lines = (function (){var iter__4394__auto__ = ((function (map__26625,map__26625__$1,start_line,end_line,num_new_lines){
return (function parinfer_codemirror$editor_support$compute_cm_change_$_iter__26627(s__26628){
return (new cljs.core.LazySeq(null,((function (map__26625,map__26625__$1,start_line,end_line,num_new_lines){
return (function (){
var s__26628__$1 = s__26628;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__26628__$1);
if(temp__5720__auto__){
var s__26628__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__26628__$2)){
var c__4392__auto__ = cljs.core.chunk_first.call(null,s__26628__$2);
var size__4393__auto__ = cljs.core.count.call(null,c__4392__auto__);
var b__26630 = cljs.core.chunk_buffer.call(null,size__4393__auto__);
if((function (){var i__26629 = (0);
while(true){
if((i__26629 < size__4393__auto__)){
var i = cljs.core._nth.call(null,c__4392__auto__,i__26629);
cljs.core.chunk_append.call(null,b__26630,cm.getLine(i));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26630),parinfer_codemirror$editor_support$compute_cm_change_$_iter__26627.call(null,cljs.core.chunk_rest.call(null,s__26628__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26630),null);
}
} else {
var i = cljs.core.first.call(null,s__26628__$2);
return cljs.core.cons.call(null,cm.getLine(i),parinfer_codemirror$editor_support$compute_cm_change_$_iter__26627.call(null,cljs.core.rest.call(null,s__26628__$2)));
}
} else {
return null;
}
...
});})(map__26625,map__26625__$1,start_line,end_line,num_new_lines))
,null,null));
});})(map__26625,map__26625__$1,start_line,end_line,num_new_lines))
;
return iter__4394__auto__.call(null,cljs.core.range.call(null,start_line,(start_line + num_new_lines)));
})();
...
var len__4601__auto___26638 = arguments.length;
var i__4602__auto___26639 = (0);
while(true){
if((i__4602__auto___26639 < len__4601__auto___26638)){
args__4607__auto__.push((arguments[i__4602__auto___26639]));

var G__26640 = (i__4602__auto___26639 + (1));
i__4602__auto___26639 = G__26640;
continue;
} else {
}
break;
...
return parinfer_codemirror.editor_support.fix_text_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4608__auto__);
});

parinfer_codemirror.editor_support.fix_text_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (cm,p__26634){
...
var change = cljs.core.get.call(null,map__26635__$1,new cljs.core.Keyword(null,"change","change",-1163046502),null);
var use_cache_QMARK_ = cljs.core.get.call(null,map__26635__$1,new cljs.core.Keyword(null,"use-cache?","use-cache?",-81331778),false);
...
var mode = (function (){var or__4002__auto__ = cljs.core.get_in.call(null,cljs.core.deref.call(null,parinfer_codemirror.state.state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key_,new cljs.core.Keyword(null,"mode","mode",654403691)], null));
...
var new_text = (function (){var G__26637 = mode;
var G__26637__$1 = (((G__26637 instanceof cljs.core.Keyword))?G__26637.fqn:null);
switch (G__26637__$1) {
case "indent-mode":
var result = (cljs.core.truth_((function (){var and__3991__auto__ = use_cache_QMARK_;
...
/** @this {Function} */
parinfer_codemirror.editor_support.fix_text_BANG_.cljs$lang$applyTo = (function (seq26632){
...
return self__4588__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26633,seq26632__$1);
});
