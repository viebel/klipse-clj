...
var digit_10097 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_10098__$1 = (vlq >>> (5));
while(true){
if((vlq_10098__$1 > (0))){
var digit_10099__$1 = (digit_10097 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_10099__$1));

var G__10100 = (vlq_10098__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__10101 = (vlq_10098__$1 >>> (5));
digit_10097 = G__10100;
vlq_10098__$1 = G__10101;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_10097));
}
break;
}
...
var G__10102 = i__$1;
var G__10103 = result__$1;
var G__10104 = shift__$1;
i = G__10102;
result = G__10103;
shift = G__10104;
continue;
