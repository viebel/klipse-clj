...
var digit_116645 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_116646__$1 = (vlq >>> (5));
while(true){
if((vlq_116646__$1 > (0))){
var digit_116647__$1 = (digit_116645 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_116647__$1));

var G__116648 = (vlq_116646__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__116649 = (vlq_116646__$1 >>> (5));
digit_116645 = G__116648;
vlq_116646__$1 = G__116649;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_116645));
}
break;
}
...
var G__116650 = i__$1;
var G__116651 = result__$1;
var G__116652 = shift__$1;
i = G__116650;
result = G__116651;
shift = G__116652;
continue;
