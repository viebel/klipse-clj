...
var l = (cljs.core.truth_(truncate)?(0):(function (){var x__4093__auto__ = (10);
var y__4094__auto__ = n;
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__4484__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4488__auto__,method_table__4484__auto__,prefer_table__4485__auto__,method_cache__4486__auto__,cached_hierarchy__4487__auto__));
})();
}
...
return ["\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),(function (){var x__4093__auto__ = n;
var y__4094__auto__ = x.length;
return ((x__4093__auto__ < y__4094__auto__) ? x__4093__auto__ : y__4094__auto__);
})())),suffix].join('');
}));
