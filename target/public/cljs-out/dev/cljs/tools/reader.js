...
var G__8411 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__8411;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__8412 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__8412,ch);
...
var G__8425 = cljs.core.conj_BANG_.call(null,a,form);
a = G__8425;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__8426 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__8427 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__8427;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__8426;
}});
/**
...
var vec__8434 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8434,(0),null);
var start_column = cljs.core.nth.call(null,vec__8434,(1),null);
...
var vec__8437 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8437,(0),null);
var end_column = cljs.core.nth.call(null,vec__8437,(1),null);
...
var vec__8440 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8440,(0),null);
var start_column = cljs.core.nth.call(null,vec__8440,(1),null);
...
var vec__8443 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8443,(0),null);
var end_column = cljs.core.nth.call(null,vec__8443,(1),null);
...
var sb = (function (){var G__8446 = (new goog.string.StringBuffer());
G__8446.append(initch);
...
var G__8448 = (function (){var G__8447 = sb;
G__8447.append(ch);

return G__8447;
})();
var G__8449 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__8448;
ch = G__8449;
continue;
}
...
switch (G__8452) {
case "\\":
var G__8456 = (function (){var G__8453 = sb;
G__8453.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__8453;
})();
var G__8457 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__8456;
ch = G__8457;
continue;
...
break;
default:
var G__8458 = (function (){var G__8454 = sb;
G__8454.append(ch);

return G__8454;
})();
var G__8459 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__8458;
ch = G__8459;
continue;
...
var line = cljs.core.nth.call(null,vec__8468,(0),null);
var column = cljs.core.nth.call(null,vec__8468,(1),null);
...
var vec__8473 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__8473,(0),null);
var column = cljs.core.nth.call(null,vec__8473,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__8478 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8478,(0),null);
var start_column = cljs.core.nth.call(null,vec__8478,(1),null);
...
var vec__8481 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8481,(0),null);
var end_column = cljs.core.nth.call(null,vec__8481,(1),null);
...
var G__8484 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__8484,true,null,opts,pending_forms);
...
var G__8485 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__8485)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__8485)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__8485)){
...
var _STAR_suppress_read_STAR__orig_val__8486 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__8487 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__8487;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__8486;
}});
...
var G__8488 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__8488,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__8488,rdr,first_line);
...
var G__8492 = matched;
var G__8493 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__8492;
finished = G__8493;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__8494 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__8495 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__8495;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__8494;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__8496 = cljs.tools.reader.arg_env;
var arg_env_temp_val__8497 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__8497;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__8498 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__8498,"(");
...
var G__8499 = (i + (1));
var G__8500 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__8496;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__8501 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__8501);
...
var G__8502 = cljs.core.next.call(null,s__$1);
var G__8503 = ret;
s__$1 = G__8502;
r = G__8503;
continue;
...
var G__8505 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__8504;
key_vals = G__8505;
continue;
} else {
...
var gensym_env_orig_val__8509 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__8510 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__8510;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__8509;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__8511 = token;
var G__8511__$1 = (((G__8511 == null))?null:cljs.core.subs.call(null,G__8511,(1)));
var G__8511__$2 = (((G__8511__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__8511__$1));
var G__8511__$3 = (((G__8511__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__8511__$2));
var G__8511__$4 = (((G__8511__$3 == null))?null:cljs.core.symbol.call(null,G__8511__$3));
if((G__8511__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__8511__$4);
}
})():(function (){var G__8512 = token;
var G__8512__$1 = (((G__8512 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__8512));
if((G__8512__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__8512__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e8519){if((e8519 instanceof Error)){
var e = e8519;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__8523,reader){
...
var opts = map__8524__$1;
var eof = cljs.core.get.call(null,map__8524__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
