...
var G__8514 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__8514;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__8515 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__8515,ch);
...
if(("\\" === ch__$1)){
var ch_8516__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_8516__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_8516__$2);
} else {
}

var G__8517 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__8517;
continue;
}
}
...
var vec__8525 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8525,(0),null);
var start_column = cljs.core.nth.call(null,vec__8525,(1),null);
...
var G__8528 = cljs.core.conj_BANG_.call(null,a,form);
a = G__8528;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__8529 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__8530 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__8530;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__8529;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__8531 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8531,(0),null);
var start_column = cljs.core.nth.call(null,vec__8531,(1),null);
...
var vec__8534 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8534,(0),null);
var end_column = cljs.core.nth.call(null,vec__8534,(1),null);
...
var vec__8537 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8537,(0),null);
var start_column = cljs.core.nth.call(null,vec__8537,(1),null);
...
var vec__8540 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8540,(0),null);
var end_column = cljs.core.nth.call(null,vec__8540,(1),null);
...
var vec__8543 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__8543,(0),null);
var start_column = cljs.core.nth.call(null,vec__8543,(1),null);
...
var vec__8546 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8546,(0),null);
var end_column = cljs.core.nth.call(null,vec__8546,(1),null);
...
var sb = (function (){var G__8549 = (new goog.string.StringBuffer());
G__8549.append(initch);
...
var G__8551 = (function (){var G__8550 = sb;
G__8550.append(ch);

return G__8550;
})();
var G__8552 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__8551;
ch = G__8552;
continue;
}
...
switch (G__8555) {
case "\\":
var G__8559 = (function (){var G__8556 = sb;
G__8556.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__8556;
})();
var G__8560 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__8559;
ch = G__8560;
continue;
...
break;
default:
var G__8561 = (function (){var G__8557 = sb;
G__8557.append(ch);

return G__8557;
})();
var G__8562 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__8561;
ch = G__8562;
continue;
...
var vec__8563 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__8563,(0),null);
var end_column = cljs.core.nth.call(null,vec__8563,(1),null);
...
var vec__8566 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__8566,(0),null);
var column = cljs.core.nth.call(null,vec__8566,(1),null);
...
var vec__8571 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__8571,(0),null);
var column = cljs.core.nth.call(null,vec__8571,(1),null);
...
var vec__8576 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__8576,(0),null);
var column = cljs.core.nth.call(null,vec__8576,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__8587 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__8587,true,null,opts,pending_forms);
...
var G__8588 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__8588)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__8588)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__8588)){
...
var _STAR_suppress_read_STAR__temp_val__8590 = true;
...
var G__8591 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__8591,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__8591,rdr,first_line);
...
var G__8595 = matched;
var G__8596 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__8595;
finished = G__8596;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__8597 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__8598 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__8598;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__8597;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__8599 = cljs.tools.reader.arg_env;
var arg_env_temp_val__8600 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__8600;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__8601 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__8601,"(");
...
var G__8602 = (i + (1));
var G__8603 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__8599;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__8604 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__8604);
...
var G__8608 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__8607;
key_vals = G__8608;
continue;
} else {
...
var gensym_env_orig_val__8612 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__8613 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__8613;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__8612;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__8614 = token;
var G__8614__$1 = (((G__8614 == null))?null:cljs.core.subs.call(null,G__8614,(1)));
var G__8614__$2 = (((G__8614__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__8614__$1));
var G__8614__$3 = (((G__8614__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__8614__$2));
var G__8614__$4 = (((G__8614__$3 == null))?null:cljs.core.symbol.call(null,G__8614__$3));
if((G__8614__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__8614__$4);
}
})():(function (){var G__8615 = token;
var G__8615__$1 = (((G__8615 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__8615));
if((G__8615__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__8615__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__8626,reader){
var map__8627 = p__8626;
...
var opts = map__8627__$1;
var eof = cljs.core.get.call(null,map__8627__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
