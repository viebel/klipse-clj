...
var o24514 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24514["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24515 = temp__5718__auto____$1;
return (o24515["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23626__auto__ = f;
return (o__23626__auto__["toString"]).call(o__23626__auto__);
} else {
return "";
}
}catch (e24516){var _ = e24516;
return "";
}});
...
try{var o__23626__auto___24518 = t;
(o__23626__auto___24518["cljs$lang$ctorPrWriter"]).call(o__23626__auto___24518,t,writer);
}catch (e24517){var __24519 = e24517;
}
...
var char_code = (function (){var o__23626__auto__ = (new String(char$));
return (o__23626__auto__["charCodeAt"]).call(o__23626__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23626__auto__ = String;
return (o__23626__auto__["fromCharCode"]).call(o__23626__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24520 = num_code;
switch (G__24520) {
case (1):
return (185);
...
var o__23626__auto__ = String;
return (o__23626__auto__["fromCharCode"]).call(o__23626__auto__,superscript_code);
});
/**
...
}catch (e24522){var _e__23633__auto__ = e24522;
return false;
}})())){
...
var vec__24523 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24523,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24526 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24526["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24527 = temp__5718__auto____$1;
return (o24527["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24530){
var vec__24531 = p__24530;
var ns_detector = cljs.core.nth.call(null,vec__24531,(0),null);
...
var G__24537 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24538 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24537;
remaining_tokens = G__24538;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24528){
var G__24529 = cljs.core.first.call(null,seq24528);
var seq24528__$1 = cljs.core.next.call(null,seq24528);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24529,seq24528__$1);
});
...
var vec__24542 = cljs.core.split_with.call(null,(function (p1__24541_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24541_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24542,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24542,(1),null);
...
var vec__24548 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24548,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24548,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24551 = cljs.core.rest.call(null,remaining_tokens);
var G__24552 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24551;
name_tokens = G__24552;
continue;
} else {
...
var vec__24555 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24555,(0),null);
var arity = cljs.core.nth.call(null,vec__24555,(1),null);
var vec__24558 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24558,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24558,(1),null);
var vec__24561 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24561,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24561,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24561,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24561,(3),null);
...
var vec__24567 = result;
var munged_ns = cljs.core.nth.call(null,vec__24567,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24567,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24567,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24567,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24567,(4),null);
var arity = cljs.core.nth.call(null,vec__24567,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__24571 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__24571,(0),null);
var args = cljs.core.nth.call(null,vec__24571,(1),null);
var vec__24574 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24574,(0),null);
var name = cljs.core.nth.call(null,vec__24574,(1),null);
...
var G__24577 = (arity + (1));
var G__24578 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24579){
var vec__24580 = p__24579;
var arity = cljs.core.nth.call(null,vec__24580,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24580,(1),null);
...
return cljs.core.get.call(null,arities,p1__24583_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24584_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24587){
var vec__24588 = p__24587;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24588,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24585){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24596__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24596__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24596__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24596__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24597 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24597,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24597,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24597,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24597,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24597,(4),null);
var arity = cljs.core.nth.call(null,vec__24597,(5),null);
...
var o__23626__auto__ = f;
return (o__23626__auto__["getBasis"]).call(o__23626__auto__);
});
/**
...
}catch (e24601){var _e__23633__auto__ = e24601;
...
var G__24602 = (obj[cljs.core.first.call(null,path)]);
var G__24603 = cljs.core.rest.call(null,path);
obj = G__24602;
path = G__24603;
continue;
} else {
...
return (function (accum,p__24604){
var vec__24605 = p__24604;
var bit = cljs.core.nth.call(null,vec__24605,(0),null);
var protocol = cljs.core.nth.call(null,vec__24605,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24608){
var vec__24609 = p__24608;
var ns = cljs.core.nth.call(null,vec__24609,(0),null);
var name = cljs.core.nth.call(null,vec__24609,(1),null);
var selector = cljs.core.nth.call(null,vec__24609,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24614,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24614,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24614,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24612_SHARP_){
return (obj[cljs.core.first.call(null,p1__24612_SHARP_)]);
});})(name,sorted_matches,vec__24614,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
