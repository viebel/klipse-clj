...
var o43130 = temp__5455__auto__;
var temp__5455__auto____$1 = (o43130["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o43131 = temp__5455__auto____$1;
return (o43131["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41747__auto__ = f;
return (o__41747__auto__["toString"]).call(o__41747__auto__);
} else {
return "";
}
}catch (e43132){var _ = e43132;
return "";
}});
...
try{var o__41747__auto___43134 = t;
(o__41747__auto___43134["cljs$lang$ctorPrWriter"]).call(o__41747__auto___43134,t,writer);
}catch (e43133){var __43135 = e43133;
}
...
var char_code = (function (){var o__41747__auto__ = (new String(char$));
return (o__41747__auto__["charCodeAt"]).call(o__41747__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41747__auto__ = String;
return (o__41747__auto__["fromCharCode"]).call(o__41747__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43136 = num_code;
switch (G__43136) {
case (1):
return (185);
...
var o__41747__auto__ = String;
return (o__41747__auto__["fromCharCode"]).call(o__41747__auto__,superscript_code);
});
/**
...
}catch (e43138){var _e__41754__auto__ = e43138;
return false;
}})())){
...
var vec__43139 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43139,(0),null);
...
var or__17825__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o43142 = temp__5455__auto__;
var temp__5455__auto____$1 = (o43142["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o43143 = temp__5455__auto____$1;
return (o43143["nameToPath"]);
} else {
return null;
}
} else {
...
var len__19134__auto___43150 = arguments.length;
var i__19135__auto___43151 = (0);
while(true){
if((i__19135__auto___43151 < len__19134__auto___43150)){
args__19144__auto__.push((arguments[i__19135__auto___43151]));

var G__43152 = (i__19135__auto___43151 + (1));
i__19135__auto___43151 = G__43152;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19145__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43146){
var vec__43147 = p__43146;
var ns_detector = cljs.core.nth.call(null,vec__43147,(0),null);
var effective_detector = (function (){var or__17825__auto__ = ns_detector;
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
var G__43153 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43154 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43153;
remaining_tokens = G__43154;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43144){
...
return self__19119__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43145,seq43144__$1);
});
...
var vec__43158 = cljs.core.split_with.call(null,(function (p1__43157_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43157_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43158,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43158,(1),null);
...
var vec__43164 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43164,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43164,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43167 = cljs.core.rest.call(null,remaining_tokens);
var G__43168 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43167;
...
var vec__43171 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43171,(0),null);
var arity = cljs.core.nth.call(null,vec__43171,(1),null);
var vec__43174 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43174,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43174,(1),null);
var vec__43177 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43177,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43177,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43177,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43177,(3),null);
...
var vec__43183 = result;
var munged_ns = cljs.core.nth.call(null,vec__43183,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43183,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43183,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43183,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43183,(4),null);
var arity = cljs.core.nth.call(null,vec__43183,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__43187 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__43187,(0),null);
var args = cljs.core.nth.call(null,vec__43187,(1),null);
var vec__43190 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43190,(0),null);
var name = cljs.core.nth.call(null,vec__43190,(1),null);
...
var G__43193 = (arity + (1));
var G__43194 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43195){
var vec__43196 = p__43195;
var arity = cljs.core.nth.call(null,vec__43196,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43196,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__17825__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__43199_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43200_SHARP_);
...
var args__19144__auto__ = [];
var len__19134__auto___43207 = arguments.length;
var i__19135__auto___43208 = (0);
while(true){
if((i__19135__auto___43208 < len__19134__auto___43207)){
args__19144__auto__.push((arguments[i__19135__auto___43208]));

var G__43209 = (i__19135__auto___43208 + (1));
i__19135__auto___43208 = G__43209;
continue;
} else {
}
break;
...
var argseq__19145__auto__ = ((((1) < args__19144__auto__.length))?(new cljs.core.IndexedSeq(args__19144__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19145__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43203){
var vec__43204 = p__43203;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43204,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43201){
var G__43202 = cljs.core.first.call(null,seq43201);
var seq43201__$1 = cljs.core.next.call(null,seq43201);
var self__19119__auto__ = this;
return self__19119__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43202,seq43201__$1);
});
...
var G__43210 = arg;
var G__43210__$1 = (((G__43210 instanceof cljs.core.Keyword))?G__43210.fqn:null);
switch (G__43210__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__17825__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__17810__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[(cljs.core.truth_((function (){var or__17825__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43212__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43212__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43212__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43212__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43213 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43213,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43213,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43213,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43213,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43213,(4),null);
var arity = cljs.core.nth.call(null,vec__43213,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__17810__auto__ = protocol_ns;
if(cljs.core.truth_(and__17810__auto__)){
return cljs.core.not.call(null,(function (){var and__17810__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__17825__auto__ = protocol_part;
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
return fn_part;
...
var o__41747__auto__ = f;
return (o__41747__auto__["getBasis"]).call(o__41747__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__17810__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__17810__auto__)){
...
}catch (e43217){var _e__41754__auto__ = e43217;
...
var G__43218 = (obj[cljs.core.first.call(null,path)]);
var G__43219 = cljs.core.rest.call(null,path);
obj = G__43218;
path = G__43219;
continue;
} else {
...
var partition_bits = (function (){var or__17825__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
return (0);
...
return (function (accum,p__43220){
var vec__43221 = p__43220;
var bit = cljs.core.nth.call(null,vec__43221,(0),null);
var protocol = cljs.core.nth.call(null,vec__43221,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43224){
var vec__43225 = p__43224;
var ns = cljs.core.nth.call(null,vec__43225,(0),null);
var name = cljs.core.nth.call(null,vec__43225,(1),null);
var selector = cljs.core.nth.call(null,vec__43225,(2),null);
...
return (function (p__43229){
var vec__43230 = p__43229;
var munged_name = cljs.core.nth.call(null,vec__43230,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43230,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43230,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43228_SHARP_){
return (obj[cljs.core.first.call(null,p1__43228_SHARP_)]);
});})(name,sorted_matches,vec__43230,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
