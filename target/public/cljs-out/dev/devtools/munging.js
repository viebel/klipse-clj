...
var o43123 = temp__5718__auto__;
var temp__5718__auto____$1 = (o43123["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o43124 = temp__5718__auto____$1;
return (o43124["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41740__auto__ = f;
return (o__41740__auto__["toString"]).call(o__41740__auto__);
} else {
return "";
}
...
try{var o__41740__auto___43127 = t;
(o__41740__auto___43127["cljs$lang$ctorPrWriter"]).call(o__41740__auto___43127,t,writer);
}catch (e43126){var __43128 = e43126;
}
...
var char_code = (function (){var o__41740__auto__ = (new String(char$));
return (o__41740__auto__["charCodeAt"]).call(o__41740__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41740__auto__ = String;
return (o__41740__auto__["fromCharCode"]).call(o__41740__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43129 = num_code;
switch (G__43129) {
case (1):
return (185);
...
var o__41740__auto__ = String;
return (o__41740__auto__["fromCharCode"]).call(o__41740__auto__,superscript_code);
});
/**
...
}catch (e43131){var _e__41747__auto__ = e43131;
return false;
}})())){
...
var vec__43132 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43132,(0),null);
...
var or__17816__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o43135 = temp__5718__auto__;
var temp__5718__auto____$1 = (o43135["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o43136 = temp__5718__auto____$1;
return (o43136["nameToPath"]);
} else {
return null;
}
} else {
...
var len__19125__auto___43143 = arguments.length;
var i__19126__auto___43144 = (0);
while(true){
if((i__19126__auto___43144 < len__19125__auto___43143)){
args__19135__auto__.push((arguments[i__19126__auto___43144]));

var G__43145 = (i__19126__auto___43144 + (1));
i__19126__auto___43144 = G__43145;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19136__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43139){
var vec__43140 = p__43139;
var ns_detector = cljs.core.nth.call(null,vec__43140,(0),null);
var effective_detector = (function (){var or__17816__auto__ = ns_detector;
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
...
var G__43146 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43147 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43146;
remaining_tokens = G__43147;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43137){
...
return self__19110__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43138,seq43137__$1);
});
...
var vec__43151 = cljs.core.split_with.call(null,(function (p1__43150_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43150_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43151,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43151,(1),null);
...
var vec__43157 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43157,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43157,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43160 = cljs.core.rest.call(null,remaining_tokens);
var G__43161 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43160;
name_tokens = G__43161;
continue;
} else {
...
var vec__43164 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43164,(0),null);
var arity = cljs.core.nth.call(null,vec__43164,(1),null);
var vec__43167 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43167,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43167,(1),null);
var vec__43170 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43170,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43170,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43170,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43170,(3),null);
...
var vec__43176 = result;
var munged_ns = cljs.core.nth.call(null,vec__43176,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43176,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43176,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43176,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43176,(4),null);
var arity = cljs.core.nth.call(null,vec__43176,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__43180 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__43180,(0),null);
var args = cljs.core.nth.call(null,vec__43180,(1),null);
var vec__43183 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43183,(0),null);
var name = cljs.core.nth.call(null,vec__43183,(1),null);
...
var G__43186 = (arity + (1));
var G__43187 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43188){
var vec__43189 = p__43188;
var arity = cljs.core.nth.call(null,vec__43189,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43189,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__17816__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__43192_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43193_SHARP_);
...
var args__19135__auto__ = [];
var len__19125__auto___43200 = arguments.length;
var i__19126__auto___43201 = (0);
while(true){
if((i__19126__auto___43201 < len__19125__auto___43200)){
args__19135__auto__.push((arguments[i__19126__auto___43201]));

var G__43202 = (i__19126__auto___43201 + (1));
i__19126__auto___43201 = G__43202;
continue;
} else {
}
break;
...
var argseq__19136__auto__ = ((((1) < args__19135__auto__.length))?(new cljs.core.IndexedSeq(args__19135__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19136__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43196){
var vec__43197 = p__43196;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43197,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43194){
var G__43195 = cljs.core.first.call(null,seq43194);
var seq43194__$1 = cljs.core.next.call(null,seq43194);
var self__19110__auto__ = this;
return self__19110__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43195,seq43194__$1);
});
...
var G__43203 = arg;
var G__43203__$1 = (((G__43203 instanceof cljs.core.Keyword))?G__43203.fqn:null);
switch (G__43203__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__17816__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__17801__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[(cljs.core.truth_((function (){var or__17816__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43205__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43205__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43205__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43205__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43206 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43206,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43206,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43206,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43206,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43206,(4),null);
var arity = cljs.core.nth.call(null,vec__43206,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__17801__auto__ = protocol_ns;
if(cljs.core.truth_(and__17801__auto__)){
return cljs.core.not.call(null,(function (){var and__17801__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__17816__auto__ = protocol_part;
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
return fn_part;
...
var o__41740__auto__ = f;
return (o__41740__auto__["getBasis"]).call(o__41740__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__17801__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__17801__auto__)){
...
}catch (e43210){var _e__41747__auto__ = e43210;
...
var G__43211 = (obj[cljs.core.first.call(null,path)]);
var G__43212 = cljs.core.rest.call(null,path);
obj = G__43211;
path = G__43212;
continue;
} else {
...
var partition_bits = (function (){var or__17816__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
return (0);
...
return (function (accum,p__43213){
var vec__43214 = p__43213;
var bit = cljs.core.nth.call(null,vec__43214,(0),null);
var protocol = cljs.core.nth.call(null,vec__43214,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43217){
var vec__43218 = p__43217;
var ns = cljs.core.nth.call(null,vec__43218,(0),null);
var name = cljs.core.nth.call(null,vec__43218,(1),null);
var selector = cljs.core.nth.call(null,vec__43218,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__43223,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43223,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43223,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43221_SHARP_){
return (obj[cljs.core.first.call(null,p1__43221_SHARP_)]);
});})(name,sorted_matches,vec__43223,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
