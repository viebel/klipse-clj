...
var o35204 = temp__5718__auto__;
var temp__5718__auto____$1 = (o35204["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o35205 = temp__5718__auto____$1;
return (o35205["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34597__auto__ = f;
return (o__34597__auto__["toString"]).call(o__34597__auto__);
} else {
return "";
}
}catch (e35206){var _ = e35206;
return "";
}});
...
try{var o__34597__auto___35208 = t;
(o__34597__auto___35208["cljs$lang$ctorPrWriter"]).call(o__34597__auto___35208,t,writer);
}catch (e35207){var __35209 = e35207;
}
...
var char_code = (function (){var o__34597__auto__ = (new String(char$));
return (o__34597__auto__["charCodeAt"]).call(o__34597__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34597__auto__ = String;
return (o__34597__auto__["fromCharCode"]).call(o__34597__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35210 = num_code;
switch (G__35210) {
case (1):
return (185);
...
var o__34597__auto__ = String;
return (o__34597__auto__["fromCharCode"]).call(o__34597__auto__,superscript_code);
});
/**
...
}catch (e35212){var _e__34604__auto__ = e35212;
return false;
}})())){
...
var vec__35213 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35213,(0),null);
...
var or__17819__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o35216 = temp__5718__auto__;
var temp__5718__auto____$1 = (o35216["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o35217 = temp__5718__auto____$1;
return (o35217["nameToPath"]);
} else {
return null;
}
} else {
...
var len__19128__auto___35224 = arguments.length;
var i__19129__auto___35225 = (0);
while(true){
if((i__19129__auto___35225 < len__19128__auto___35224)){
args__19138__auto__.push((arguments[i__19129__auto___35225]));

var G__35226 = (i__19129__auto___35225 + (1));
i__19129__auto___35225 = G__35226;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19139__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35220){
var vec__35221 = p__35220;
var ns_detector = cljs.core.nth.call(null,vec__35221,(0),null);
var effective_detector = (function (){var or__17819__auto__ = ns_detector;
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
var G__35227 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35228 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35227;
remaining_tokens = G__35228;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35218){
...
return self__19113__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35219,seq35218__$1);
});
...
var vec__35232 = cljs.core.split_with.call(null,(function (p1__35231_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35231_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35232,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35232,(1),null);
...
var vec__35238 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35238,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35238,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35241 = cljs.core.rest.call(null,remaining_tokens);
var G__35242 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35241;
name_tokens = G__35242;
continue;
} else {
...
var vec__35245 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35245,(0),null);
var arity = cljs.core.nth.call(null,vec__35245,(1),null);
var vec__35248 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35248,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35248,(1),null);
var vec__35251 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35251,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35251,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35251,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35251,(3),null);
...
var vec__35257 = result;
var munged_ns = cljs.core.nth.call(null,vec__35257,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35257,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35257,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35257,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35257,(4),null);
var arity = cljs.core.nth.call(null,vec__35257,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__35261 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__35261,(0),null);
var args = cljs.core.nth.call(null,vec__35261,(1),null);
var vec__35264 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35264,(0),null);
var name = cljs.core.nth.call(null,vec__35264,(1),null);
...
var G__35267 = (arity + (1));
var G__35268 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35269){
var vec__35270 = p__35269;
var arity = cljs.core.nth.call(null,vec__35270,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35270,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__17819__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__35273_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__35274_SHARP_);
...
var args__19138__auto__ = [];
var len__19128__auto___35281 = arguments.length;
var i__19129__auto___35282 = (0);
while(true){
if((i__19129__auto___35282 < len__19128__auto___35281)){
args__19138__auto__.push((arguments[i__19129__auto___35282]));

var G__35283 = (i__19129__auto___35282 + (1));
i__19129__auto___35282 = G__35283;
continue;
} else {
}
break;
...
var argseq__19139__auto__ = ((((1) < args__19138__auto__.length))?(new cljs.core.IndexedSeq(args__19138__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19139__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35277){
var vec__35278 = p__35277;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35278,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35275){
var G__35276 = cljs.core.first.call(null,seq35275);
var seq35275__$1 = cljs.core.next.call(null,seq35275);
var self__19113__auto__ = this;
return self__19113__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35276,seq35275__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__17819__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__17804__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[(cljs.core.truth_((function (){var or__17819__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35286__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35286__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35286__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35286__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35287 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35287,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35287,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35287,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35287,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35287,(4),null);
var arity = cljs.core.nth.call(null,vec__35287,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__17804__auto__ = protocol_ns;
if(cljs.core.truth_(and__17804__auto__)){
return cljs.core.not.call(null,(function (){var and__17804__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__17819__auto__ = protocol_part;
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
return fn_part;
...
var o__34597__auto__ = f;
return (o__34597__auto__["getBasis"]).call(o__34597__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__17804__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__17804__auto__)){
...
}catch (e35291){var _e__34604__auto__ = e35291;
...
var G__35292 = (obj[cljs.core.first.call(null,path)]);
var G__35293 = cljs.core.rest.call(null,path);
obj = G__35292;
path = G__35293;
continue;
} else {
...
var partition_bits = (function (){var or__17819__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
return (0);
...
return (function (accum,p__35294){
var vec__35295 = p__35294;
var bit = cljs.core.nth.call(null,vec__35295,(0),null);
var protocol = cljs.core.nth.call(null,vec__35295,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35298){
var vec__35299 = p__35298;
var ns = cljs.core.nth.call(null,vec__35299,(0),null);
var name = cljs.core.nth.call(null,vec__35299,(1),null);
var selector = cljs.core.nth.call(null,vec__35299,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__35304,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35304,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__35304,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__35302_SHARP_){
return (obj[cljs.core.first.call(null,p1__35302_SHARP_)]);
});})(name,sorted_matches,vec__35304,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
