...
var G__24619 = devtools.prefs.pref.call(null,v);
v = G__24619;
continue;
} else {
return v;
...
}catch (e24622){var _e__23633__auto__ = e24622;
return false;
}})();
...
}catch (e24626){var _e__23633__auto__ = e24626;
return false;
}})();
...
}catch (e24628){var _e__23633__auto__ = e24628;
return false;
}}
}
});
...
var vec__24630 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24630,(0),null);
var name = cljs.core.nth.call(null,vec__24630,(1),null);
...
return cljs.core.some.call(null,(function (p1__24633_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24633_SHARP_);
}),template);
});
