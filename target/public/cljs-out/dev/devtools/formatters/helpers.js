...
var G__43253 = devtools.prefs.pref.call(null,v);
v = G__43253;
continue;
} else {
return v;
...
var and__17810__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__17810__auto__){
var and__17810__auto____$1 = (!(cljs.core.var_QMARK_.call(null,value)));
...
var or__17825__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e43256){var _e__41754__auto__ = e43256;
return false;
}})();
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
var or__17825__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e43260){var _e__41754__auto__ = e43260;
return false;
}})();
...
}catch (e43262){var _e__41754__auto__ = e43262;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__17810__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__17810__auto__)){
var and__17810__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_.call(null,f)));
if(and__17810__auto____$1){
...
var and__17810__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__17810__auto__)){
...
var or__17825__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
var and__17810__auto__ = (function (){var or__17825__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__17825__auto__)){
return or__17825__auto__;
} else {
...
var vec__43264 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__43264,(0),null);
var name = cljs.core.nth.call(null,vec__43264,(1),null);
...
var and__17810__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__17810__auto__)){
...
return cljs.core.some.call(null,(function (p1__43267_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43267_SHARP_);
}),template);
});
