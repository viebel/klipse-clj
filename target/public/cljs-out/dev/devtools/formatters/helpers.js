...
var G__150675 = devtools.prefs.pref.call(null,v);
v = G__150675;
continue;
} else {
return v;
...
}catch (e150678){var _e__50953__auto__ = e150678;
return false;
}})();
...
}catch (e150682){var _e__50953__auto__ = e150682;
return false;
}})();
...
}catch (e150684){var _e__50953__auto__ = e150684;
return false;
}}
}
});
...
var vec__150686 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__150686,(0),null);
var name = cljs.core.nth.call(null,vec__150686,(1),null);
...
return cljs.core.some.call(null,(function (p1__150689_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__150689_SHARP_);
}),template);
});
