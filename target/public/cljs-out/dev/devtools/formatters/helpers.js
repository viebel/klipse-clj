...
var G__35327 = devtools.prefs.pref.call(null,v);
v = G__35327;
continue;
} else {
return v;
...
var and__17804__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__17804__auto__){
var and__17804__auto____$1 = (!(cljs.core.var_QMARK_.call(null,value)));
...
var or__17819__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e35330){var _e__34604__auto__ = e35330;
return false;
}})();
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
var or__17819__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e35334){var _e__34604__auto__ = e35334;
return false;
}})();
...
}catch (e35336){var _e__34604__auto__ = e35336;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__17804__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__17804__auto__)){
var and__17804__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_.call(null,f)));
if(and__17804__auto____$1){
...
var and__17804__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__17804__auto__)){
...
var or__17819__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
var and__17804__auto__ = (function (){var or__17819__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
} else {
...
var vec__35338 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__35338,(0),null);
var name = cljs.core.nth.call(null,vec__35338,(1),null);
...
var and__17804__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__17804__auto__)){
...
return cljs.core.some.call(null,(function (p1__35341_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__35341_SHARP_);
}),template);
});
