...
var G__65399 = devtools.prefs.pref.call(null,v);
v = G__65399;
continue;
} else {
return v;
...
}catch (e65405){var _e__22753__auto__ = e65405;
return false;
}})();
...
}catch (e65409){var _e__22753__auto__ = e65409;
return false;
}})();
...
}catch (e65411){var _e__22753__auto__ = e65411;
return false;
}}
}
});
...
var vec__65415 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__65415,(0),null);
var name = cljs.core.nth.call(null,vec__65415,(1),null);
...
return cljs.core.some.call(null,(function (p1__65418_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__65418_SHARP_);
}),template);
});
