...
var G__24229 = devtools.prefs.pref.call(null,v);
v = G__24229;
continue;
} else {
return v;
...
}catch (e24232){var _e__23243__auto__ = e24232;
return false;
}})();
...
}catch (e24236){var _e__23243__auto__ = e24236;
return false;
}})();
...
}catch (e24238){var _e__23243__auto__ = e24238;
return false;
}}
}
});
...
var vec__24240 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24240,(0),null);
var name = cljs.core.nth.call(null,vec__24240,(1),null);
...
return cljs.core.some.call(null,(function (p1__24243_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24243_SHARP_);
}),template);
});
