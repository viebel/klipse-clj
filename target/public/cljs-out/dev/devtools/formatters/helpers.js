...
var G__34943 = devtools.prefs.pref.call(null,v);
v = G__34943;
continue;
} else {
return v;
...
var and__3991__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3991__auto__){
var and__3991__auto____$1 = (!(cljs.core.var_QMARK_.call(null,value)));
...
var or__4002__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e34946){var _e__33756__auto__ = e34946;
return false;
}})();
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
var or__4002__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e34950){var _e__33756__auto__ = e34950;
return false;
}})();
...
}catch (e34952){var _e__33756__auto__ = e34952;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__3991__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__3991__auto__)){
var and__3991__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_.call(null,f)));
if(and__3991__auto____$1){
...
var and__3991__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__3991__auto__)){
...
var or__4002__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
...
var and__3991__auto__ = (function (){var or__4002__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
...
var vec__34954 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__34954,(0),null);
var name = cljs.core.nth.call(null,vec__34954,(1),null);
...
var and__3991__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__3991__auto__)){
...
return cljs.core.some.call(null,(function (p1__34957_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__34957_SHARP_);
}),template);
});
