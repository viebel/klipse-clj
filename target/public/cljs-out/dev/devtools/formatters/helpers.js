...
var G__41382 = devtools.prefs.pref.call(null,v);
v = G__41382;
continue;
} else {
return v;
...
}catch (e41385){var _e__22753__auto__ = e41385;
return false;
}})();
...
}catch (e41389){var _e__22753__auto__ = e41389;
return false;
}})();
...
}catch (e41391){var _e__22753__auto__ = e41391;
return false;
}}
}
});
...
var vec__41393 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__41393,(0),null);
var name = cljs.core.nth.call(null,vec__41393,(1),null);
...
return cljs.core.some.call(null,(function (p1__41396_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41396_SHARP_);
}),template);
});
