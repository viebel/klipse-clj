...
var len__19128__auto___35384 = arguments.length;
var i__19129__auto___35385 = (0);
while(true){
if((i__19129__auto___35385 < len__19128__auto___35384)){
args__19138__auto__.push((arguments[i__19129__auto___35385]));

var G__35386 = (i__19129__auto___35385 + (1));
i__19129__auto___35385 = G__35386;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19139__auto__);
});
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq35381){
...
return self__19113__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35382,G__35383,seq35381__$2);
});
...
if(cljs.core.truth_((function (){var or__17819__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__18496__auto__,writer__18497__auto__,opt__18498__auto__){
return cljs.core._write.call(null,writer__18497__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__17804__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__17804__auto__){
var or__17819__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__35387_SHARP_){
return (!((cljs.core.meta.call(null,p1__35387_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__35388__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__17819__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e35392){var _e__34604__auto__ = e35392;
return false;
}})();
if(cljs.core.truth_(or__17819__auto__)){
return or__17819__auto__;
...
}catch (e35394){var _e__34604__auto__ = e35394;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__35396 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__35397 = devtools.formatters.state.get_current_state.call(null);
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__35397;

try{var map__35398 = opts;
...
var markup_db = cljs.core.get.call(null,map__35398__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__35396;
}});
...
;
var temp__5718__auto___35403 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___35403)){
var managed_print_level_35404 = temp__5718__auto___35403;
var _STAR_print_level_STAR__orig_val__35401_35405 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__35402_35406 = managed_print_level_35404;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__35402_35406;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR__orig_val__35401_35405,_STAR_print_level_STAR__temp_val__35402_35406,managed_print_level_35404,temp__5718__auto___35403,writer,opts,job_fn){
return (function (p1__35400_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__35400_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__35401_35405,_STAR_print_level_STAR__temp_val__35402_35406,managed_print_level_35404,temp__5718__auto___35403,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__35401_35405;
}} else {
job_fn.call(null);
}
