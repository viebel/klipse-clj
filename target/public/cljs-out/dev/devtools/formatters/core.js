...
var and__3991__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__3991__auto__){
var or__4002__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e38323){var _e__33756__auto__ = e38323;
return false;
...
}catch (e38325){var _e__33756__auto__ = e38325;
return false;
...
}catch (e38327){var _e__33756__auto__ = e38327;
return false;
...
}catch (e38329){var _e__33756__auto__ = e38329;
return false;
...
}catch (e38331){var _e__33756__auto__ = e38331;
return false;
}})())){
...
}catch (e38333){var _e__33756__auto__ = e38333;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__38335 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__38336 = (function (){var or__4002__auto__ = config;
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
...
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__38336;

try{return raw_fn.call(null,value);
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__38335;
}});
});
...
return (function() { 
var G__38338__delegate = function (args){
...
var G__38338 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38339__i = 0, G__38339__a = new Array(arguments.length -  0);
while (G__38339__i < G__38339__a.length) {G__38339__a[G__38339__i] = arguments[G__38339__i + 0]; ++G__38339__i;}
  args = new cljs.core.IndexedSeq(G__38339__a,0,null);
} 
return G__38338__delegate.call(this,args);};
G__38338.cljs$lang$maxFixedArity = 0;
G__38338.cljs$lang$applyTo = (function (arglist__38340){
var args = cljs.core.seq(arglist__38340);
return G__38338__delegate(args);
});
...
var pre_handler = (function (){var or__4002__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
...
var post_handler = (function (){var or__4002__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__4002__auto__)){
return or__4002__auto__;
} else {
return cljs.core.identity;
