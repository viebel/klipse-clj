...
var o__23626__auto___25119 = (function (){var o__23626__auto__ = (function (){var o__23626__auto__ = Promise;
return (o__23626__auto__["resolve"]).call(o__23626__auto__);
})();
return (o__23626__auto__["then"]).call(o__23626__auto__,callback);
})();
(o__23626__auto___25119["catch"]).call(o__23626__auto___25119,devtools.async.rethrow_outside_promise);
...
var G__25120_25121 = Error;
var target__23631__auto___25122 = G__25120_25121;
if(cljs.core.truth_(target__23631__auto___25122)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25120_25121)].join(''),"\n","target__23631__auto__"].join('')));
}

(target__23631__auto___25122["stackTraceLimit"] = Infinity);
