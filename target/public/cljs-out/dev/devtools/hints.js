...
}catch (e24992){var _e = e24992;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___24995 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___24995)){
var seen_errors_24996 = temp__5718__auto___24995;
if(cljs.core.truth_(seen_errors_24996.has(self))){
} else {
seen_errors_24996.add(self);

var temp__5720__auto___24997 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___24997)){
var sense_24998 = temp__5720__auto___24997;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24998)].join('');
} else {
}
}
} else {
