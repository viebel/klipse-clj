...
var reader = (function (){var or__17816__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__17816__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__17816__auto__)){
return or__17816__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__45753__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__45753__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__45753__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5718__auto___45755 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___45755)){
var seen_errors_45756 = temp__5718__auto___45755;
if(cljs.core.truth_(seen_errors_45756.has(self))){
} else {
seen_errors_45756.add(self);

var temp__5720__auto___45757 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___45757)){
var sense_45758 = temp__5720__auto___45757;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_45758)].join('');
} else {
}
}
} else {
