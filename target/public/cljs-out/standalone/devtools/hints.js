...
}catch (e24826){var _e = e24826;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___24829 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___24829)){
var seen_errors_24830 = temp__5802__auto___24829;
if(cljs.core.truth_(seen_errors_24830.has(self))){
} else {
seen_errors_24830.add(self);

var temp__5804__auto___24831 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___24831)){
var sense_24832 = temp__5804__auto___24831;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24832)].join('');
} else {
}
}
} else {
