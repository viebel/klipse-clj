...
var G__24063 = devtools.prefs.pref.call(null,v);
v = G__24063;
continue;
} else {
return v;
...
}catch (e24066){var _e__23077__auto__ = e24066;
return false;
}})();
...
}catch (e24070){var _e__23077__auto__ = e24070;
return false;
}})();
...
}catch (e24072){var _e__23077__auto__ = e24072;
return false;
}}
}
});
...
var vec__24074 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24074,(0),null);
var name = cljs.core.nth.call(null,vec__24074,(1),null);
...
return cljs.core.some.call(null,(function (p1__24077_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24077_SHARP_);
}),template);
});
